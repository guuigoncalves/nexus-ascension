                ...
                >
                    ...
                    <div className="p-3 border-t border-white/10 bg-slate-950 space-y-2">
                        ...
                        {canActivateAbility && onActivateAbility && (
                            ...
                            >
                                <Zap size={12} /> {card.cardId === '90' && (card.counters?.lanternTurns || 0) > 0 ? 'AT Extra' : card.cardId === '93' && (card.counters?.helaTurns || 0) > 0 && !(card.counters?.helaStealUsed || 0) ? 'Roubar Carta' : card.cardId === '36' && (card.counters?.thorTurns || 0) > 0 && !(card.counters?.thorEliminateUsed || 0) ? 'Eliminar Oponente' : card.rarity === 'Efeito' ? 'Efeito' : 'Habilidade'}
                            </button>
                        )}
